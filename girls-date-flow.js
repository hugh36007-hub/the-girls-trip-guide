...
(()=>{'use strict';if(document.querySelector('script[data-payment-nudge-loader="girls"]'))return;const script=document.createElement('script');script.src='/girls-payment-nudge.js?v=1';script.async=false;script.dataset.paymentNudgeLoader='girls';document.head.append(script)})();
