...
assert.match(html,/girls-app-v2\.js\?v=10/,'core app cache version missing');
...
assert.match(html,/girls-performance-loader\.js\?v=19/,'runtime loader cache version missing');
assert.match(sw,/gtg-pwa-v38-hidden-gallery-mobile-touch/,'service worker cache must advance for push delivery');
