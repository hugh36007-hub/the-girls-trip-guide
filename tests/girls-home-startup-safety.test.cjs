...
assert.match(html,/girls-performance-loader\.js\?v=20/,'runtime loader cache version missing');
assert.match(sw,/gtg-pwa-v39-hidden-gallery-local-hold/,'service worker cache must advance for push delivery');
