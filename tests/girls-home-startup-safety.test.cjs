...
assert.match(html,/girls-performance-loader\.js\?v=25/,'runtime loader cache version missing');
assert.match(sw,/gtg-pwa-v45-plan-payer-close/,'service worker cache must advance for push delivery');
