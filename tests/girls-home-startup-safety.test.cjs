...
assert.match(html,/girls-performance-loader\.js\?v=23/,'runtime loader cache version missing');
assert.match(sw,/gtg-pwa-v42-hidden-gallery-upload/,'service worker cache must advance for push delivery');
