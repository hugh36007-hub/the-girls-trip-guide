...
assert.match(html,/girls-performance-loader\.js\?v=18/,'runtime loader cache version missing');
assert.match(sw,/gtg-pwa-v37-hidden-gallery-touch/,'service worker cache must advance for push delivery');
