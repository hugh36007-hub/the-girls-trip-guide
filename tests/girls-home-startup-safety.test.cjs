...
assert.match(html,/girls-performance-loader\.js\?v=26/,'runtime loader cache version missing');
assert.match(sw,/gtg-pwa-v46-plan-payer-picker/,'service worker cache must advance for push delivery');
