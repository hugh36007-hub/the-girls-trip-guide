...
assert.match(html,/girls-performance-loader\.js\?v=27/,'runtime loader cache version missing');
assert.match(sw,/gtg-pwa-v47-first-arrival-notifications/,'service worker cache must advance for push delivery');
