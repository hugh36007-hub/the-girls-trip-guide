...
assert.match(html,/girls-app-v2\.js\?v=8/,'core app cache version missing');
...
assert.match(html,/girls-performance-loader\.js\?v=16/,'runtime loader cache version missing');
assert.match(sw,/gtg-pwa-v35-girls-media-runtime/,'service worker cache must advance for push delivery');
