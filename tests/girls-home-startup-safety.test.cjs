...
assert.match(html,/girls-performance-loader\.js\?v=14/,'runtime loader cache version missing');
assert.match(sw,/gtg-pwa-v33-push/,'service worker cache must advance for push delivery');
