...
assert.match(html,/girls-performance-loader\\.js\\?v=28/,'runtime loader cache version missing');
assert.match(sw,/gtg-pwa-v48-travel-documents-light/,'service worker cache must advance for push delivery');
