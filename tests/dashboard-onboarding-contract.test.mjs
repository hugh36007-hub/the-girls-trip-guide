...
test('web host loads onboarding without losing current logo and Evidence refinements',()=>{
  ...
  assert.match(host,/function syncApprovedAuthLogo\(\)/);
  assert.match(host,/function syncEvidenceBadge\(\)/);
});
