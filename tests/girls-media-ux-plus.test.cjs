...
if(!loader.includes('/girls-media-ux-plus.js?v=2')||!loader.includes("if(mode==='full')await loadBundle('evidenceFull')"))throw new Error('Girls media UX enhancer v2 must load only with the Full Evidence route');
