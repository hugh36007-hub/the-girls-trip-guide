...
if(html.includes('/girls-media-ux-plus.js?v=3'))throw new Error('Girls media UX enhancer must not execute on Home startup');
if(!loader.includes('/girls-media-ux-plus.js?v=3')||!loader.includes("if(mode==='full')await loadBundle('evidenceFull')"))throw new Error('Girls media UX enhancer v3 must load only with the Full Evidence route');
