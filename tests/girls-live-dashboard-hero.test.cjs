...
assert.match(html,/girls-performance-loader\.js\?v=27/,'the private shell must cache-bust the unified runtime loader');
...
assert.match(sw,/gtg-pwa-v47-first-arrival-notifications/,'the current Home composition must use the push-capable offline cache generation');
