...
assert.match(html,/girls-performance-loader\.js\?v=13/,'the private shell must cache-bust the unified runtime loader');
...
assert.match(sw,/gtg-pwa-v31-plan-money-entry/,'the current Home composition must use the latest offline cache generation');
