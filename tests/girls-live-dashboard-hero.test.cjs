...
assert.match(html,/girls-performance-loader\.js\?v=26/,'the private shell must cache-bust the unified runtime loader');
...
assert.match(sw,/gtg-pwa-v46-plan-payer-picker/,'the current Home composition must use the push-capable offline cache generation');
