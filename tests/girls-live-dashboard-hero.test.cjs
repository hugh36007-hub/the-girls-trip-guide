...
assert.match(html,/girls-performance-loader\.js\?v=22/,'the private shell must cache-bust the unified runtime loader');
...
assert.match(sw,/gtg-pwa-v41-hidden-gallery-controller/,'the current Home composition must use the push-capable offline cache generation');
