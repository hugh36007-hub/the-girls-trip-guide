...
assert.match(html,/girls-performance-loader\.js\?v=20/,'the private shell must cache-bust the unified runtime loader');
...
assert.match(sw,/gtg-pwa-v39-hidden-gallery-local-hold/,'the current Home composition must use the push-capable offline cache generation');
