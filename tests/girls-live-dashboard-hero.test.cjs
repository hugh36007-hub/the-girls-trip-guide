...
assert.match(html,/girls-performance-loader\.js\?v=18/,'the private shell must cache-bust the unified runtime loader');
...
assert.match(sw,/gtg-pwa-v37-hidden-gallery-touch/,'the current Home composition must use the push-capable offline cache generation');
