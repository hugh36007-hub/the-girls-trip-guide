...
assert.match(html,/girls-performance-loader\.js\?v=25/,'the private shell must cache-bust the unified runtime loader');
...
assert.match(sw,/gtg-pwa-v45-plan-payer-close/,'the current Home composition must use the push-capable offline cache generation');
