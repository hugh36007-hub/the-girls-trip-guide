...
assert.match(html,/girls-performance-loader\.js\?v=12/,'the private shell must cache-bust the unified runtime loader');
...
assert.match(sw,/gtg-pwa-v30-free-home-consistency/,'the current Home composition must use the latest offline cache generation');
