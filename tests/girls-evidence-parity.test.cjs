...
const checks=[
 ['parity layer excluded from Home startup',!html.includes('/girls-evidence-parity.js?v=3')],
 ['parity layer retained by Full Evidence route',loader.includes('/girls-evidence-parity.js?v=3')&&loader.includes("if(mode==='full')await loadBundle('evidenceFull')")],
