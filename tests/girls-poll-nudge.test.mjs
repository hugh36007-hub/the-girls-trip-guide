...
assert(!html.includes('defer src="/girls-poll-nudge.js?v=2"'),'poll nudge must not block initial app paint');
assert(deferred.includes('/girls-poll-nudge.js?v=2'),'deferred loader must retain poll nudge');
