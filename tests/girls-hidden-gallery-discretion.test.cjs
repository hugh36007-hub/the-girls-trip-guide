...
assert(html.includes('/girls-app-v2.js?v=11')&&html.includes('/girls-hero-vault-ux.js?v=4')&&html.includes('/girls-performance-loader.js?v=21'),'Updated scripts must be cache-busted');
assert(sw.includes("gtg-pwa-v40-hidden-gallery-rollback")&&sw.includes('/girls-performance-loader.js?v=16'),'PWA cache generation must include the updated loader');
