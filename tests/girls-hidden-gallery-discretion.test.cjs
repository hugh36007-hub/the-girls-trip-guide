...
assert(html.includes('/girls-app-v2.js?v=7')&&html.includes('/girls-hero-vault-ux.js?v=4')&&html.includes('/girls-performance-loader.js?v=11'),'Updated scripts must be cache-busted');
assert(sw.includes("gtg-pwa-v29-runtime-consolidation"),'PWA cache generation not bumped');
