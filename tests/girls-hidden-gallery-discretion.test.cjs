...
assert(html.includes('/girls-hero-vault-ux.js?v=3')&&html.includes('/girls-performance-loader.js?v=4'),'Updated scripts must be cache-busted');
assert(sw.includes("gtg-pwa-v12"),'PWA cache generation not bumped');
