...
assert(html.includes('/girls-app-v2.js?v=12')&&html.includes('/girls-session-guard.js?v=3')&&html.includes('/girls-hero-vault-ux.js?v=5')&&html.includes('/girls-role-aware-dock.js?v=4')&&html.includes('/girls-performance-loader.js?v=24'),'Updated scripts must be cache-busted');
assert(sw.includes("gtg-pwa-v43-launch-drawer")&&sw.includes('/girls-app-v2.js?v=12')&&sw.includes('/girls-session-guard.js?v=3')&&sw.includes('/girls-performance-loader.js?v=24'),'PWA cache generation must include the repaired runtime');
