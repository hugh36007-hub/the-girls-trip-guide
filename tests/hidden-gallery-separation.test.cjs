...
const checks=[
 ...
 ['long hold arms at four seconds and opens only after pointerup', home.includes('PHOTO_HOLD_MS=4000')&&home.includes('photoHold.ready=true')&&home.includes("window.addEventListener('pointerup',event=>finishPointer(event,false)")&&home.includes('if(shouldOpen)setTimeout(openHidden,0)')],
