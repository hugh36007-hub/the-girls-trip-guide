...
const perfPos=loader.indexOf('/girls-media-performance-max.js?v=2'),uxPos=loader.indexOf('/girls-media-ux-plus.js?v=3');
const checks=[
  ...
  ['media layers excluded from Home startup',!html.includes('/girls-media-performance-max.js?v=2')&&!html.includes('/girls-media-ux-plus.js?v=3')],
