...
assert(html.indexOf('/girls-fx-expenses.js?v=4')>html.indexOf('/girls-app-v2.js?v=12'),'Direct FX runtime must load after app core');
assert(html.indexOf('/girls-fx-expenses.js?v=4')<html.indexOf('/girls-date-flow.js?v=7'),'Direct FX runtime must own Add Expense before secondary form enhancers');
