...
assert(!html.includes('/girls-media-readiness.js?v=3')&&!html.includes('/girls-direct-photo-viewer.js?v=5'),'Evidence readiness/viewer must not execute on Home startup');
const warmIndex=loader.indexOf('/girls-media-readiness.js?v=3'),viewerIndex=loader.indexOf('/girls-direct-photo-viewer.js?v=5');
