...
const checks=[
 ['guard loaded after app core',html.includes('/girls-session-guard.js?v=3')&&html.indexOf('girls-app-v2.js')<html.indexOf('girls-session-guard.js')],
 ...
 ['PIN and hero forms are not cancel-and-replayed',!src.includes("['heroForm','setPinForm']")&&!src.includes('form.requestSubmit')],
 ['identity and destructive-action guards remain',src.includes('identityPreflight')&&src.includes('protectedSelector')&&src.includes('stopImmediatePropagation')]
];
